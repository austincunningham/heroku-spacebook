  ...
  public static void selectionSortOutbox(List<User> users)
	  {
	      for (int i = 0; i < users.size(); i += 1)
	      {
	          ...
	          { 
	              ...
	              {
	                  swapUsers(users, i, j);
	                  Logger.info("Swaping (" + users.get(j).outbox.size()+") with (" + users.get(i).outbox.size()+")");
	  ...
	  public static void selectionSortFriendships(List<User> users)
	  {
	      for (int i = 0; i < users.size(); i += 1)
	      {
	          ...
	          { 
	              ...
	              {
	                  swapUsers(users,i,j);
	                  Logger.info("Swaping (" + users.get(j).friendships.size()+") with (" + users.get(i).friendships.size()+")");
